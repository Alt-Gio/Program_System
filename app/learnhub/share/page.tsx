...
// their OS share sheet, the OS calls /learnhub/share?title=…&text=…&url=…
//
// We just forward the shared payload into the feed composer via the
// existing #compose hash anchor (used elsewhere too — see LeftRail's
  ...
  useEffect(() => {
    ...
    if (composed) {
      try {
        ...
        // sessionStorage can throw in private mode — falling back to
