...
// GET /api/learnhub/gmail/connect/callback
// Same shape as the Calendar callback. Persists the upgraded token set
// (including the gmail.readonly scope) back into learnhub_google_credentials.
...
export async function GET(request: NextRequest) {
  ...
  let returnTo = "/learnhub/admin/cert-ingest";
  ...
  try {
    ...
    if (!tokenRes.ok) {
      ...
      console.error("[Gmail OAuth] token exchange:", tokenRes.status, body);
